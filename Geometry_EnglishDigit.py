...
for i in range(classes):
    path = os.path.join(cur_path,'geometry_EnglishDigit',str(i))
...
#Converting the labels into one hot encodnig
...
ws = websocket.WebSocketApp("ws://192.168.43.248:8000",  on_message = on_message,  on_error = on_error, on_close = on_close)
ws.on_open = on_open
